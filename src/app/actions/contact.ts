    ...
    try {
        ...
        if (process.env.RESEND_API_KEY) {
            await resend.emails.send({
                from: 'Neuilly Basketball <onboarding@resend.dev>', // À remplacer par votre domaine une fois validé
                to: ['contact@neuillybasketball.com'], // À remplacer par votre email de réception
                replyTo: email,
